...
<script>
    ...
    $('.task_start').on('click', () => !time_counter ? time_counter = setInterval(() => taskTime.html(+taskTime.html() + 1), 1000) : {})
    $('.task_pause').on('click', () => {clearInterval(time_counter); time_counter = false} )
    $('.task_finish').on('click', () => {
